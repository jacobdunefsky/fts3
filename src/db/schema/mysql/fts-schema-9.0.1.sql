...
`/*!40101 SET character_set_client = @saved_cs_client */;`
INSERT INTO t_plinks (plink_id, ingress, egress, cap, ldelay)
VALUES (UUID(), '*', '*', '10', '100');
...
`/*!40101 SET character_set_client = @saved_cs_client */;`
/*INSERT INTO t_projects (vo_name, source_se, dest_se, proj_id)
VALUES ('vo1', 'root://xrd1', 'root://xrd2', UUID()),
        ('vo1', 'root://xrd1', 'root://xrd3', UUID());*/ /*demo 1*/

INSERT INTO t_projects (vo_name, source_se, dest_se, proj_id) /*demo 2*/
VALUES  ('vo1', '*', '*', UUID()), /* NOTE: both should use similar ends*/
        ('vo2', '*', '*', UUID()),
        ('vo1', '*', '*', UUID());
...
INSERT INTO t_routing (source_se, dest_se, plink_id)
SELECT 'root://xrd1', 'root://xrd2', plink_id FROM t_plinks;

INSERT INTO t_routing (source_se, dest_se, plink_id)
SELECT 'root://xrd1', 'root://xrd3', plink_id FROM t_plinks;
...
`/*!40101 SET character_set_client = @saved_cs_client */;`
/*INSERT INTO t_bounds (proj_id, plink_id, max_throughput, relative_share)
SELECT t1.proj_id, t2.plink_id, '5', '0'
FROM t_projects t1 
INNER JOIN t_routing t2 ON (t1.source_se = t2.source_se)
                       AND (t1.dest_se = t2.dest_se)*/ /*demo 1: exact matching */
INSERT INTO t_bounds (proj_id, plink_id, max_throughput, relative_share)
SELECT t1.proj_id, t2.plink_id, '5', '0'
FROM t_projects t1 
CROSS JOIN t_plinks t2 /*demo 2: wildpcard matching */
